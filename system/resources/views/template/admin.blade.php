                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('admin/user')}}" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-users"></i>Data User</a>
                                
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{url('artikel')}}" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-book"></i> Data Artikel</a>
                                
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{url('komen')}}" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-file"></i> Data Komen</a>
